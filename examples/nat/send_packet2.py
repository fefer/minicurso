...
if args.dl:
    ...
    pkt = Ether(dst='00:aa:bb:00:00:a5',src='00:55:00:00:00:00')/IP(dst='192.168.0.1',src='192.168.0.10')/ICMP()/"icmp"
    port2send = port_map[2]
else:
    pkt = Ether(dst='00:aa:bb:00:00:04',src='00:44:00:00:00:00')/IP(dst='192.168.0.10',src='10.0.0.10')/TCP(sport=20, dport=80)/"NAT Ul"
